...
from app.api.v1.endpoints import (
    ...
    links, smart, channels, rules, acl, overview, media, scale,
)
...
# Compatibility aliases kept for older clients and deployed frontends.
api_router.include_router(firmware.router, prefix="/firmwares", tags=["firmware-legacy"])
api_router.include_router(firmware.router, prefix="/firmware_upgrade_tasks", tags=["firmware-legacy"])
